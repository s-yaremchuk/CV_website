...
const words = [
  { text: 'JAVASCRIPT', x: '5%',   y: '12%',  rotate: -90, size: '9vw',  opacity: 0.032 },
  { text: 'NODE.JS',    x: '72%',  y: '8%',   rotate: 0,   size: '5vw',  opacity: 0.028 },
  { text: 'API',        x: '40%',  y: '22%',  rotate: -15, size: '14vw', opacity: 0.022 },
  { text: 'VITE',       x: '82%',  y: '38%',  rotate: 90,  size: '8vw',  opacity: 0.035 },
  { text: 'FULLSTACK',  x: '10%',  y: '45%',  rotate: 0,   size: '4.5vw',opacity: 0.025 },
  ...
  { text: 'GSAP',       x: '60%',  y: '92%',  rotate: 0,   size: '3.5vw',opacity: 0.025 },
