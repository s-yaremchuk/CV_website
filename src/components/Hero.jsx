    ...
    <section className="hero-section" id="hero" ref={heroRef}>
      <div className="hero-content">
        ...
        <div className="hero-cta-group">
          ...
          <a href={`${import.meta.env.BASE_URL}Serhii_Yaremchuk_JavaScript_Developer.pdf`} download="Serhii_Yaremchuk_JavaScript_Developer.pdf" className="hero-btn secondary">
            {t.downloadCV}
          </a>
        </div>
      </div>
